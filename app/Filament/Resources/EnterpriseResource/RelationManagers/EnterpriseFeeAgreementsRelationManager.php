...
class EnterpriseFeeAgreementsRelationManager extends RelationManager
{
        ...
        return $table
            ...
            ->actions([
                Action::make('editar')
                    ...
                    ->color('warning')
                    ->url(fn ($record) => \App\Filament\Resources\EnterpriseFeeAgreementResource::getUrl('edit', ['record' => $record->id])),
                ...
                Action::make('pdf')
                    ...
                    ->url(
                        fn ($record) => $record->pdf_path
                            ...
                            : route('enterprise-fee-agreement.pdf', $record->id)
                    )
                    ->openUrlInNewTab(),
            ]);
    }
